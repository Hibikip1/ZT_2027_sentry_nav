...
def generate_launch_description():
    ...
    # HERO 融合栈开关:True = HERO MPC/MINCO/dog_map 栈;False = 原 pb2025 栈
    ...
    declare_hero_stack_cmd = DeclareLaunchArgument(
        "hero_stack",
        default_value="True",
        description="Use HERO fusion stack (MPC/MINCO/dog_map). False falls back to original pb2025 stack.",
    )

    # HERO 融合:dog_map 点云后端(单雷达模式,消费 registered_scan)
    dog_map_node_cmd = Node(
        package="dog_map",
    ...
    ld.add_action(dog_map_node_cmd)
