...
struct _as_string
{
  ...
  static_assert(lexy::_detail::is_compatible_char_type<Encoding, _char_type>, "invalid "
                                                                              "character "
                                                                              "type/"
                                                                              "encoding "
                                                                              "combinatio"
  ...
  static constexpr String&& _case_folding(String&& str)
  {
    ...
    else if constexpr(CaseFoldingDSL::template is_inplace<Encoding>)
    {
      ...
      auto reader =
          typename CaseFoldingDSL::template case_folding<decltype(original_reader)>{
            original_reader
          };
  ...
  {
    static_assert(lexy::char_type_compatible_with_reader<Reader, _char_type>, "cannot "
                                                                              "convert "
                                                                              "lexeme to "
                                                                              "this "
                                                                              "string "
