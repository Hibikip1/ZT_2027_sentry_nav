...
public:
  ...
  class iterator : public lexy::_detail::bidirectional_iterator_base<iterator, value_type,
                                                                     value_type, void>
  {
  public:
  ...
  struct p
  {
    ...
    struct _cont
    {
      ...
      LEXY_PARSER_FUNC static bool parse(Context& context, Reader& reader,
                                         PrevArgs&&... args, lexy::lexeme<Reader> lexeme)
      {
...
struct _sym_dsl : _sym<Table, void, void>
{
  ...
  {
    static_assert(sizeof...(R) == 0, "symbol() must not be used in the presence of "
