                                        ...
                                        std::size_t size)
{
  ...
  {
    static_assert(lexy::_detail::error<Encoding>, "cannot encode a code point in this "
                                                  "encoding");
    (void)cp;
    (void)buffer;
    (void)size;
...
constexpr cp_result<Reader> parse_code_point(Reader reader)
{
  ...
  {
    static_assert(lexy::_detail::error<typename Reader::encoding>, "no known code point "
                                                                   "for this encoding");
    return {};
  }
}
