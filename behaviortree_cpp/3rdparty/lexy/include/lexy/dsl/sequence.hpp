...
struct _seq_impl<R1, R2, R3, R4, R5>
{
  ...
  using p = lexy::parser_for<
      ...
      lexy::parser_for<
          R2,
          lexy::parser_for<R3, lexy::parser_for<R4, lexy::parser_for<R5, NextParser>>>>>;
};
...
struct _seq_impl<R1, R2, R3, R4, R5, R6>
{
  ...
  using p = lexy::parser_for<
      ...
      lexy::parser_for<
          R2, lexy::parser_for<
                  R3, lexy::parser_for<
                          R4, lexy::parser_for<R5, lexy::parser_for<R6, NextParser>>>>>>;
};
template <typename R1, typename R2, typename R3, typename R4, typename R5, typename R6,
          typename R7>
          ...
          R2, lexy::parser_for<
                  R3, lexy::parser_for<
                          R4, lexy::parser_for<
                                  R5, lexy::parser_for<
                                          R6, lexy::parser_for<
                                                  R7, lexy::parser_for<_seq_impl<T...>,
                                                                       NextParser>>>>>>>>;
};
