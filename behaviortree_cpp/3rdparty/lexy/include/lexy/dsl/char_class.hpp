                         ...
                         index_sequence<SingleIdx...>>
{
  ...
  template <typename Encoding>
  LEXY_FORCE_INLINE static constexpr bool match([[maybe_unused]]
                                                typename Encoding::int_type cur)
  {
    return
...
struct char_class_base : token_base<Derived>, _char_class_base
{
  ...
  struct tp
  {
    ...
    constexpr bool try_parse(Reader reader)
    {
      ...
      {
        static_assert(Derived::char_class_unicode(), "cannot use this character class "
      ...
      {
        static_assert(!Derived::char_class_unicode(), "cannot use this character class "
                                                      "with non-Unicode char encodings");
    ...
    static_assert(
        !non_unicode
            ...
            || ((!Cs::char_class_unicode() ||
                 std::is_same_v<decltype(Cs::char_class_match_cp(0)), std::false_type>) &&
                ...),
