    ...
    namespace nonstd
{
  ...
  nsel_constexpr auto invoke_member_function_impl(
      ...
      Args&&... args) noexcept(noexcept((std::forward<ObjectT>(obj).*
  ...
  nsel_constexpr auto invoke_member_function_impl(
      FnT ClassT::* memfnptr, ObjectT&& obj,
      Args&&... args) noexcept(noexcept((obj.get().*
                                         memfnptr)(std::forward<Args>(args)...)))
  ...
  template <typename MemberT, typename ClassT,
            typename ObjectT nsel_REQUIRES_T(
                is_reference_wrapper<typename std20::remove_cvref<ObjectT>::type>::value)>
  nsel_constexpr auto invoke_member_object_impl(
      MemberT ClassT::* memobjptr, ObjectT&& obj) noexcept(noexcept(obj.get().*memobjptr))
  ...
  nsel_constexpr auto invoke(F&& f, Args&&... args) noexcept(noexcept(
      invoke_member_function_impl(std::forward<F>(f), std::forward<Args>(args)...)))
      -> decltype(invoke_member_function_impl(std::forward<F>(f),
  ...
  template <typename F, typename... Args nsel_REQUIRES_T(
                            std::is_member_object_pointer<
                                typename std20::remove_cvref<F>::type>::value)>
  nsel_constexpr auto invoke(F&& f, Args&&... args) noexcept(noexcept(
      invoke_member_object_impl(std::forward<F>(f), std::forward<Args>(args)...)))
      -> decltype(invoke_member_object_impl(std::forward<F>(f),
                                            std::forward<Args>(args)...))
  {
  ...
  using invoke_result_nocvref_t = typename std20::remove_cvref<decltype(invoke(
      std::declval<F>(), std::declval<Args>()...))>::type;

#if nsel_P2505R >= 5
  template <typename F, typename... Args>
  using transform_invoke_result_t = typename std::remove_cv<decltype(invoke(
      std::declval<F>(), std::declval<Args>()...))>::type;
#else
  template <typename F, typename... Args>
  ...
  struct valid_unexpected_type
    : std::integral_constant<
          bool, std::is_same<T, typename std20::remove_cvref<T>::type>::value &&
  ...
  public:
...
#if nsel_P2505R >= 4
    template <typename G = E nsel_REQUIRES_T(std::is_copy_constructible<E>::value&&
    ...
    template <typename G = E nsel_REQUIRES_T(std::is_move_constructible<E>::value&&
                                                 std::is_convertible<G, E>::value)>
    ...
    template <typename F nsel_REQUIRES_T(
        detail::is_expected<detail::invoke_result_nocvref_t<F, const value_type&> >::
            value&& std::is_same<typename detail::invoke_result_nocvref_t<
    ...
    template <typename F nsel_REQUIRES_T(
        detail::is_expected<detail::invoke_result_nocvref_t<F, const error_type&> >::
            value&& std::is_same<typename detail::invoke_result_nocvref_t<
    ...
    {
      return has_value() ?
                 expected<detail::transform_invoke_result_t<F, const value_type&>,
                          error_type>(detail::invoke(std::forward<F>(f), **this)) :
                 make_unexpected(error());
    }

    template <typename F nsel_REQUIRES_T(
        std::is_constructible<error_type, const error_type&>::value&& std::is_void<
            detail::transform_invoke_result_t<F, const value_type&> >::value)>
    ...
    template <typename F nsel_REQUIRES_T(
        detail::valid_unexpected_type<
            detail::transform_invoke_result_t<F, error_type&> >::value&&
            std::is_constructible<value_type, value_type&>::value)>
    nsel_constexpr14
  ...
  public:
    ...
    // Monadic operations (P2505)
    template <typename F nsel_REQUIRES_T(
        detail::is_expected<detail::invoke_result_nocvref_t<F> >::value&& std::is_same<
    ...
    template <typename F nsel_REQUIRES_T(
        detail::is_expected<detail::invoke_result_nocvref_t<F, const error_type&> >::
            value&& std::is_void<typename detail::invoke_result_nocvref_t<
